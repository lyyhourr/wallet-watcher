    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                ...
                <form action="" className='flex flex-col gap-4 ' onSubmit={handleUpdate}>
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="" className="text-xs sm:text-sm md:text-base ">
                            amount
                        </label>
                        <Input placeholder='expense' name='amount' defaultValue={props.amount} className='col-span-3' onChange={handleChange} />
                    </div>
                    <div className="grid grid-cols-4 items-center">
                        <label htmlFor="" className="text-xs sm:text-sm md:text-base ">
                            Category
                        </label>
                        <CategorySelector formData={formData} setFormData={setFormData} category={["salary", "bonus", "other"]} defaultValue={props.category} />
                    </div>
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="" className="text-xs sm:text-sm md:text-base ">
                            date
                        </label>
                        <Input placeholder='expense' type='date' name='date' defaultValue={props.date} className='col-span-3' onChange={handleChange} />
                    </div>
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="" className="text-xs sm:text-sm md:text-base ">
                            description
                        </label>
                        <Textarea placeholder='description...' name='description' defaultValue={props.description} className='col-span-3' onChange={handleChange} />
                    </div>
