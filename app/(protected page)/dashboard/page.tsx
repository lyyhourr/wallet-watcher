  ...
  return (
    <div className="h-full w-full flex flex-col gap-3">
      <header className="flex justify-between items-center px-1 lg:px-4  gap-3 py-3">
        ...
        <p className={`${fontHeader.className} text-xl md:text-3xl`}>{months[currentMonth - 1]}</p>
        <DropdownMenu>
      ...
      <h1 className={`${fontHeader.className} text-3xl text-center `}>
        Remaining Balance: <span className={cn(balance > 0 ? "text-green-600" : "text-red-600")}>{balance}$</span>
      </h1>
