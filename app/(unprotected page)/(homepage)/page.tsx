...
const features = [
  ...
  },
  {
    ...
    description: "Dive deep into your financial data with the ability to filter by day, month, year, and category.",
  },
  {
    feature: "Account Management",
    image: "accountmanagement.png",
    description: "Securely manage your account with features like password change, recovery, and account deletion.",
  },
]
const steps = [
  {
    title: "Login",
    image: "login.png",
    description: "Start by securely logging into your personalized account. Your financial dashboard awaits, tailored just for you.",
  },
  {
    title: "Start Tracking",
    image: "tracking.png",
    description: "Manage your expenses using our user-friendly app. Input your expenditures, categorize transactions, and stay in control wherever you are.",
  },
  {
    title: "Update Your Profile",
    image: "updatepf.png",
    description: "Keep your information current to unlock the latest features aligned with your financial goals.",
  },
]
      ...
      <section className="flex justify-center items-center w-full gap-5 flex-col md:flex-row" >
        {
          steps.map((item: any, i: number) => (
            <div className=" w-full  bg-white shadow-lg rounded-xl p-5 flex flex-col gap-3 h-[530px]" key={i}>
              <p className={`${fontHero.className} text-5xl text-center`}>Step {i + 1} </p>
              ...
              <p className={`${fontHero.className} text-4xl text-center `}>{item.title} </p>
